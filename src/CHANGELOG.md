## [1.1.6]
1. Добавлена возможность регулирования высоты бегущей строки
2. Добавлено сбрасывание бегущей строки при появлении нового поста
3. Изменена верстка анимированного блока (убран палец, заменен бантик)
